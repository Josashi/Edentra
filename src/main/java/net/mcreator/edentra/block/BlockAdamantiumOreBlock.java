...
public class BlockAdamantiumOreBlock extends ElementsEdentra.ModElement {
	@GameRegistry.ObjectHolder("edentra:adamantiumoreblock")
	public static final Block block = null;
	public BlockAdamantiumOreBlock(ElementsEdentra instance) {
		super(instance, 2);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("edentra:adamantiumoreblock", "inventory"));
	}
