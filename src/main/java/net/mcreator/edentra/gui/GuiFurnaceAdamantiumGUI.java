...
import net.mcreator.edentra.item.ItemAdamantiumCoal;
...
public class GuiFurnaceAdamantiumGUI extends ElementsEdentra.ModElement {
	public static int GUIID = 7;
	public static HashMap guistate = new HashMap();
	public GuiFurnaceAdamantiumGUI(ElementsEdentra instance) {
		super(instance, 88);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 44, 21) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 44, 57) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemAdamantiumCoal.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 109, 39) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("edentra:textures/furnaceadamantiumgui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Edentra Furnace", 52, 4, -3407872);
		}
