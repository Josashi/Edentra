...
public class GuiOptiumChest extends ElementsEdentra.ModElement {
	public static int GUIID = 10;
	public static HashMap guistate = new HashMap();
	public GuiOptiumChest(ElementsEdentra instance) {
		super(instance, 127);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 266, 121) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 284, 121) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 302, 121) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 266, 139) {
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 284, 139) {
			}));
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 302, 139) {
			}));
			this.customSlots.put(6, this.addSlotToContainer(new Slot(internal, 6, 266, 157) {
			}));
			this.customSlots.put(7, this.addSlotToContainer(new Slot(internal, 7, 284, 157) {
			}));
			this.customSlots.put(8, this.addSlotToContainer(new Slot(internal, 8, 302, 157) {
			}));
			this.customSlots.put(10, this.addSlotToContainer(new Slot(internal, 10, 23, 121) {
			}));
			this.customSlots.put(9, this.addSlotToContainer(new Slot(internal, 9, 329, 139) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(11, this.addSlotToContainer(new Slot(internal, 11, 23, 157) {
			}));
			this.customSlots.put(12, this.addSlotToContainer(new Slot(internal, 12, 59, 139) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
		...
		public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
			...
			if (slot != null && slot.getHasStack()) {
				...
				if (index < 108) {
					...
					if (index < 108 + 27) {
						if (!this.mergeItemStack(itemstack1, 108 + 27, this.inventorySlots.size(), true)) {
							return ItemStack.EMPTY;
						}
					} else {
						if (!this.mergeItemStack(itemstack1, 108, 108 + 27, false)) {
							return ItemStack.EMPTY;
						}
					}
					return ItemStack.EMPTY;
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("edentra:textures/optiumchest.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("ULTIMATE OPTIUM CHEST", 123, 2, -6750055);
		}
