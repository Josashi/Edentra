...
public class GuiFurnaceMithrilGUI extends ElementsEdentra.ModElement {
	public static int GUIID = 6;
	public static HashMap guistate = new HashMap();
	public GuiFurnaceMithrilGUI(ElementsEdentra instance) {
		super(instance, 87);
	}
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 44, 57) {
				...
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemMithrilCoal.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("edentra:textures/furnacemithrilgui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("MITHRIL FURNACE", 52, 4, -3407872);
		}
