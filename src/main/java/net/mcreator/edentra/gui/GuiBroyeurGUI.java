...
import net.mcreator.edentra.item.ItemOptiumParticule;
import net.mcreator.edentra.item.ItemMithrilParticule;
import net.mcreator.edentra.item.ItemIronParticule;
import net.mcreator.edentra.item.ItemGoldParticule;
import net.mcreator.edentra.item.ItemDiamondParticule;
import net.mcreator.edentra.item.ItemAdamantiumParticule;
...
public class GuiBroyeurGUI extends ElementsEdentra.ModElement {
	public static int GUIID = 4;
	public static HashMap guistate = new HashMap();
	public GuiBroyeurGUI(ElementsEdentra instance) {
		super(instance, 71);
	}
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 80, 12) {
				...
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(Blocks.COBBLESTONE, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 8, 48) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemIronParticule.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 35, 48) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemGoldParticule.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 62, 48) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemDiamondParticule.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 98, 48) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemOptiumParticule.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 125, 48) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemMithrilParticule.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(6, this.addSlotToContainer(new Slot(internal, 6, 152, 48) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemAdamantiumParticule.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			int si;
			int sj;
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("edentra:textures/broyeurgui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Broyeur", 7, 2, -16777216);
		}
